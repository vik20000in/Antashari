...
$songs = @(
    ...
    "lutt-putt-gaya.mp3",
    "jamal-kudu.mp3",
    "ajaa-sajna-milke.mp3",
    "naseeb-se.mp3",
    "aaj-ki-raat-stree2.mp3",
    "tauba-tauba.mp3",
    "husn-tera-tauba-tauba.mp3",
    "akhiyaan-gulaab.mp3",
    "laal-peeli-akhiyaan.mp3",
    "o-sajni-re.mp3",
    "angaaron.mp3",
    "peelings.mp3",
    "sooseki.mp3",
    "saami-saami-pushpa.mp3",
    "kasam-se.mp3",
    "chal-kudiye.mp3",
    "phoolon-ka-taaron-ka.mp3",
    "hauli-hauli.mp3",
    "tu-hai-kahan.mp3",
    "arjan-vailly-reprise.mp3",
    "deva-deva.mp3",
    "sun-sajni.mp3",
    "khudaya-ve.mp3",
    "chaleya-reprise.mp3",
